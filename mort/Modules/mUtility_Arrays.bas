Attribute VB_Name = "mUtility_Arrays"
Option Explicit
Option Compare Text
...
'   - NOTE: ADDED some array methods made by Kevin Brostoff
'
...
Function getMasterArray(Base0 As Boolean, ParamArray Arrays() As Variant)
    'https://stackoverflow.com/questions/46051448/excel-vba-joining-two-arrays
    Dim result As Variant, v As Variant
    Dim count As Long, Count2 As Long, lowBound As Long, lOffset As Long, X As Long, x1 As Long, Y As Long
...
Public Function V_To_S_Array(vArr() As Variant) As String()
    ' NOTE: Move this function outside of this module and into
    '       the Array Module.
    ' Takes a single-dim array and converts from variant to string
    Dim sArr() As String
    Dim i As Long
